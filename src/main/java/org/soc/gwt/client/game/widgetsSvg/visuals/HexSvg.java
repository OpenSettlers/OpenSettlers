...
import org.soc.gwt.client.game.widgetsAbstract.visuals.AbstractHexVisual;
                ...
                ClickHandler, MouseOutHandler
{
    ...
    public HexSvg(Hex hex, BoardVisual parent)
    {
        ...
        this.point = getSvgParent().calculatePosition(hex.location());
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.client.visuals.board.HexVisual#updateEnabled()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.client.visuals.board.HexVisual#updateVisible()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.client.visuals.board.AbstractHexVisual#updateDarkened()
     */
    @Override
