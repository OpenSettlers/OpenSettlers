...
import org.soc.common.game.DevelopmentCard.VictoryPoint.VictoryPointView;
...
public class VictoryPointGwt implements VictoryPointView {
  private HorizontalPanel rootPanel = new HorizontalPanel();
  private Button btnPlay = new Button(I.get().constants().play());
  private EventBus eventBus = new SimpleEventBus();

  public VictoryPointGwt() {
    rootPanel.setSpacing(5);
    rootPanel.add(new Image(R.icons.victoryPoint48()));
