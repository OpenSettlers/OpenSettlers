...
public class DesktopGamePanelLayout implements GamePanelLayoutWidget
{
  ...
  {
    boardActionResourcesPanel.addEast(gameWidget.actionsWidget()
            .asWidget(), 15);
    boardActionResourcesPanel.addSouth(gameWidget.getStatusWidget()
            .asWidget(), 5);
    boardActionResourcesPanel.add(gameWidget.boardVisualWidget());
  ...
  @Override public Panel getRootPanel()
  {
    return rootPanel;
  }
}
