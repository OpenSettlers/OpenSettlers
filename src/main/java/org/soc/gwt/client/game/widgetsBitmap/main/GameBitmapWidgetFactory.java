...
public class GameBitmapWidgetFactory implements GameWidgetFactory
{
  ...
  @Override public PlayersInfoWidget createPlayersWidget()
  {
    return new PlayersBitmapWidget(gameWidget);
  }
  @Override public BankStockWidget createBankStockWidget()
  {
    return new AbstractBankStockWidget(gameWidget.game());
  }
  @Override public StatusWidget createStatusDiceWidget()
  {
    return new StatusBitmapPanel(gameWidget);
  }
  @Override public BankTradeWidget createBankTradeWidget()
  {
    return new TradeBankDialog(gameWidget);
  }
  @Override public ResourcesGainedWidget createResourcesGainedWidget()
  {
    return new ResourcesGainedBitmapWidget(gameWidget);
  }
  @Override public PlayerStuffWidget createPlayerStuffWidget(GamePlayer player)
  {
    return new PlayerStuffBitmapWidget(gameWidget, player);
  }
  @Override public StealCardWidget createStealCardWidget(GamePlayer player)
  {
    return new StealCardDialog(gameWidget, player);
  }
  @Override public LooseCardsDialog createLooseCardsDialog()
  {
    return new HotseatLooseCards(gameWidget);
  }
  @Override public GameOverDialog createGameOverDialog()
  {
    return new HotSeatGameOverDialog();
  }
  @Override public HotseatLooseCardsDialog createHotseatLooseCardsDialog()
  {
    return new HotseatLooseCards(gameWidget);
  }
  @Override public BoardVisualSvgWidget createBoardVisualWidget()
  {
    return new BoardVisualSvgWidget(gameWidget);
  }
  @Override public HistoryWidget createHistoryWidget()
  {
    return getGameDetailsWidget();
  }
  @Override public ChatWidget createChatWidget()
  {
    return getGameDetailsWidget();
  }
  @Override public DebugWidget createDebugWidget()
  {
    return getGameDetailsWidget();
  }
  @Override public QueueWidget createQueueWidget()
  {
    return getGameDetailsWidget();
  }
  @Override public GameDetailsWidget createDetailsWidget()
  {
    return getGameDetailsWidget();
  }
  @Override public HotSeatActionsPlayersWidgetImpl createHotSeatActionsPlayersWidget()
  {
    return new HotSeatActionsPlayersWidgetImpl(gameWidget, this);
  }
  @Override public HotSeatTradePlayersWidgetImpl createHotSeatTradePlayersWidget()
  {
