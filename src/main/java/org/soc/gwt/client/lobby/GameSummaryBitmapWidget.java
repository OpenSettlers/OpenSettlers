...
import org.soc.common.lobby.actions.JoinGame;
...
public class GameSummaryBitmapWidget extends VerticalPanel implements
        GameSummaryWidget, UserListChangedHandler
{
  ...
  public GameSummaryBitmapWidget(LobbyWidget lobbyWidget, GameDto gameInfo)
  {
    this();
    this.lobbyWidget = lobbyWidget;
    this.gameInfo = gameInfo;
    //    gameInfo.getUsers().addUserListChangedHandler(this);
    updateGameName();
    updateBoardName();
    updateAmountPlayers();
  }
  ...
  public GameSummaryBitmapWidget()
  {
    ...
    image = new Image(
            "WEB-INF/classes/org.soc/gwtClient/images/defaultTheme/size32/City.png");
