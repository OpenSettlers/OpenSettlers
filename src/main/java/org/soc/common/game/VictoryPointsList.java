...
public class VictoryPointsList implements Iterable<VictoryPointItem>, Serializable {
  ...
  @Override public Iterator<VictoryPointItem> iterator() {
    return points.iterator();
  }
  public void addVictoryPointsChangedListener(VictoryPointsChangedHandler handler) {
    eventBus.addHandler(VictoryPointsChangedEvent.getType(), handler);
  }
