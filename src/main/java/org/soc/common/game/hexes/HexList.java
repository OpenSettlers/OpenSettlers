...
public class HexList implements Collection<Hex>, Serializable
{
  ...
  /* Returns new list of mainland for 3 players. Same as MainLand4p, but 1 TimberHex and 1 SheepHex
   * replaced for 2 DesertHexes. */
  ...
  @Override public boolean addAll(Collection<? extends Hex> arg0)
  {
