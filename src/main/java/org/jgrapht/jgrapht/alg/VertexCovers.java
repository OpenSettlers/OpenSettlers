 ...
 *                   Christian Hammer
 *
 * $Id: VertexCovers.java 568 2007-09-30 00:12:18Z perfecthash $
 *
 * Changes
 * -------
...
import org.jgrapht.jgrapht.alg.util.VertexDegreeComparator;
import org.jgrapht.jgrapht.graph.Subgraph;
import org.jgrapht.jgrapht.graph.UndirectedSubgraph;
...
public abstract class VertexCovers
{
     ...
     * directions you can use {@link org.jgrapht.jgrapht.Graphs#undirectedGraph(Graph)}
     * or {@link org.jgrapht.jgrapht.graph.AsUndirectedGraph}.</p>
     *
     * @param g the graph for which vertex cover approximation is to be found.
     *
     * @return a set of vertices which is a vertex cover for the specified
