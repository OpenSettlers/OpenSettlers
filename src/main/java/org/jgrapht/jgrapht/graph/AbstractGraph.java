 ...
 *
 * $Id: AbstractGraph.java 568 2007-09-30 00:12:18Z perfecthash $
 *
 * Changes
 * -------
        ...
        implements Graph<V, E>
{
   ...
   * string representation of the vertex set, and 'E' is the string representation of the edge set.
   * 
  ...
  /** Removes all the edges in this graph that are also contained in the specified edge array. After
   * this call returns, this graph will contain no edges in common with the specified edges. This
   * method will invoke the {@link Graph#removeEdge(Object)} method.
   * 
