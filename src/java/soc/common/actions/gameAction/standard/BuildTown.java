...
public class BuildTown extends AbstractTurnAction
{
    ...
    public GameBehaviour getNextActionBehaviour()
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getNextActionBehaviourFactory().createBuildTownBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getOpponentReceiveBehaviourFactory().createBuildTownBehaviour(
                        this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getReceiveBehaviourFactory().createBuildTownBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getSendBehaviourFactory().createBuildTownBehaviour(this);
    }
