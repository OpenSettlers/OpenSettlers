...
public class RollDice extends AbstractTurnAction
{
    ...
    public GameBehaviour getNextActionBehaviour()
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getNextActionBehaviourFactory().createRollDiceBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getOpponentReceiveBehaviourFactory().createRollDiceBehaviour(
                        this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getReceiveBehaviourFactory().createRollDiceBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getSendBehaviourFactory().createRollDiceBehaviour(this);
    }
