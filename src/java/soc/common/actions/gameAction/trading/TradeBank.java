...
public class TradeBank extends AbstractTurnAction
{
    ...
    public GameBehaviour getNextActionBehaviour()
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getNextActionBehaviourFactory().createTradeBankBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getOpponentReceiveBehaviourFactory().createTradeBankBehaviour(
                        this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getReceiveBehaviourFactory().createTradeBankBehaviour(this);
    }
    ...
    {
        return Core.get().getClientFactory().getBehaviourFactory()
                .getSendBehaviourFactory().createTradeBankBehaviour(this);
    }
