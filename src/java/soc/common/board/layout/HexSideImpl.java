...
public class HexSideImpl implements Serializable, HexSide
{
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getHex1()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getHex2()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getHexPoint1()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getHexPoint2()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getHighestOrLeftestHex()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getNeighbourPoints()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getDirection()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getOtherPoint(soc.common.board.layout.HexPoint)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see soc.common.board.layout.HexSide#getOtherLocation(soc.common.board.layout.HexLocation)
     */
    @Override
