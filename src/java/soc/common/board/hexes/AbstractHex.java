...
public abstract class AbstractHex implements Hex
{
    ...
    /*
     * Length of a side. Base constant from where all other values are calculated from.
     */
    ...
    public void addTerritoryChangedEventHandler(TerritoryChangedEventHandler handler)
    {
        eventBus.addHandler(TerritoryChangedEvent.TYPE, handler);
    }
}
