...
public class PlayYearOfPlentyDialog extends DialogBox
{
    ...
    public PlayYearOfPlentyDialog(YearOfPlenty yearOfPlenty, IGamePanel gamePanel)
    {
        this();
    ...
    public PlayYearOfPlentyDialog()
    {
        ...
        Image image = new Image(ImageLibrary.getIcon(yearOfPlenty, 48));
        ...
        Label lblPickAnyTwo = new Label("Pick any two resources to add to your hand resources");
