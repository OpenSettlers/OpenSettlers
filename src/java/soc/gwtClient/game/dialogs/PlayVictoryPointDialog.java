...
public class PlayVictoryPointDialog extends DialogBox
{
    ...
    public PlayVictoryPointDialog(VictoryPoint victoryPoint, IGamePanel gamePanel)
    {
        this();
    ...
    public PlayVictoryPointDialog()
    {
        ...
        Image image = new Image(ImageLibrary.getIcon(victoryPoint, 48));
        ...
        Label lblGainOneVictorypoint = new Label("Gain one victorypoint by playing this development card");
