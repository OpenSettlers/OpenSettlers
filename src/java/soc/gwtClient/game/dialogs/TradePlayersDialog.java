...
public class TradePlayersDialog extends PopupPanel
{
    ...
    public TradePlayersDialog(IGamePanel gamePanel)
    {
        ...
        giveResourcesListWidget = createResourceListWidget(
                giveResources, playerHand, null);
        
        wantedResourceListWidget = createResourceListWidget(wantResources, null, null);
        
        giveResourcePickerWidget = createResourcePickerWidget(
                giveResources,  null, playerHand, gamePanel);
        
        wantedResourcePickerWidget = createResourcePickerWidget(
                wantResources, null, null, gamePanel);
        
        for (Player opponent : gamePanel.getGame().getPlayers())
        {
            ITradePlayerStatusWidget tradeStatus = 
                new BitmapTradePlayerStatusWidget(gamePanel, opponent, gamePanel.getPlayingPlayer());
    ...
    public TradePlayersDialog()
    {
        ...
        pnlPlayersResponse.setHorizontalAlignment(HasHorizontalAlignment.ALIGN_CENTER);
        ...
        Label lblResourcesYouHave = new Label("Resources you have dire need for");
