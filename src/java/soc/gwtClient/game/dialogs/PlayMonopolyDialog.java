...
public class PlayMonopolyDialog extends DialogBox
{
    ...
    public PlayMonopolyDialog(Monopoly monopoly, GamePanel gamePanel)
    {
        this();
    ...
    public PlayMonopolyDialog()
    {
        ...
        Image image = new Image(Resources.icons().monopoly());
        ...
        Label lblPickAResource = new Label(
                "Pick a resource type, then steal all resources of that type from every player");
