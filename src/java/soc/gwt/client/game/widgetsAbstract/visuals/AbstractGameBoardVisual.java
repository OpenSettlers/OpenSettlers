        ...
        implements GameBoardVisual, PiecesChangedEventHandler
{
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.GameBoardVisual#createVisualFactory
     * ()
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.AbstractBoardVisual#clicked(soc
     * .gwtClient.visuals.abstractVisuals.PieceVisual,
     * soc.gwt.client.visuals.abstractVisuals.BoardVisual)
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.AbstractBoardVisual#mouseEnter(
     * soc.gwt.client.visuals.abstractVisuals.PieceVisual,
     * soc.gwt.client.visuals.abstractVisuals.BoardVisual)
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.AbstractBoardVisual#mouseOut(soc
     * .gwtClient.visuals.abstractVisuals.PieceVisual,
     * soc.gwt.client.visuals.abstractVisuals.BoardVisual)
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.AbstractBoardVisual#hideTerritories
     * ()
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.AbstractBoardVisual#showTerritories
     * ()
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.GameBoardVisual#quitbehaviour()
     */
    @Override
     ...
     * 
     * @see
     * soc.gwt.client.visuals.abstractVisuals.GameBoardVisual#showLongestRoad()
     */
    @Override
