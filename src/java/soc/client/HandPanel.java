...
public class HandPanel extends Panel implements ActionListener
{
    ...
    public void clickPlayCardButton()
    {
        ...
        if (item.equals("Soldier"))
        {
            ...
            {
                cardTypeToPlay = DevCardConstants.KNIGHT;
            }
        }
        else if (item.equals("Road Building"))
        {
            ...
            {
                cardTypeToPlay = DevCardConstants.ROADS;
            }
        }
        else if (item.equals("Year of Plenty"))
        {
            ...
            {
                cardTypeToPlay = DevCardConstants.DISC;
            }
        }
        else if (item.equals("Monopoly"))
        {
            ...
            {
                cardTypeToPlay = DevCardConstants.MONO;
            }
        }
    ...
    public void addPlayer(String name)
    {
        ...
        {
            D.ebugPrintln("HandPanel.addPlayer: This is our hand");
    ...
    public void updateAtTurn()
    {
        ...
        // roll, via a RollDicePrompt message.
    ...
    public void updateButtonsAtAdd()
    {
        ...
        {
            updateRollButton();
            bankBut.setEnabled(game.getGameState() == Game.PLAY1);
        }
        else
        {
    ...
    protected void pnameCalcColors()
    {
        if (pnameActiveBG != null)
            return;
        pnameActiveBG = PlayerInterface.makeGhostColor(getBackground());
    }
    ...
    public void updateDevCards()
    {
        ...
        synchronized (cardList.getTreeLock())
        {
            ...
            {
                int numOld = cards.getAmount(DevCardSet.OLD, cardTypes[i]);
                int numNew = cards.getAmount(DevCardSet.NEW, cardTypes[i]);
                if (numOld > 0)
                    hasOldCards = true;
    ...
    public void updateCurrentOffer()
    {
        if (inPlay)
        {
            TradeOffer currentOffer = player.getCurrentOffer();
    ...
    {
        rollBut.setEnabled(game.getGameState() == Game.PLAY);
    }
    ...
    public void updateValue(int vt)
    {
        ...
        case ROADS:
            ...
            roadSq.setIntValue(player.getNumPieces(PlayingPiece.ROAD));
        ...
        case CITIES:
            ...
            citySq.setIntValue(player.getNumPieces(PlayingPiece.CITY));
            ...
            PopupMenu
    {
        ...
        protected HandPanel hpan;

        protected ResourceTradePopupMenu(HandPanel hp, String title)
        {
            super(title);
            hpan = hp;
        }
