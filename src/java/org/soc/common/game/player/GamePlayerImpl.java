...
public class GamePlayerImpl implements GamePlayer
{
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getRoadBuildingTokens()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#setRoadBuildingTokens(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getVictoryPoints()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getPlayedDevelopmentCards()
     */
     ...
     * 
     * @see
     * org.soc.common.game.GamePlayer#removeResources(org.soc.common.board.resources
     * .ResourceList)
     */
     ...
     * (non-Javadoc)
     * 
     * @seesoc.common.game.GamePlayer#addResources(org.soc.common.board.resources.
     * ResourceList)
     */
     ...
     * (non-Javadoc)
     * 
     * @seesoc.common.game.GamePlayer#useDevelopmentCard(org.soc.common.game.
     ...
     * (non-Javadoc)
     * 
     * @seesoc.common.game.GamePlayer#addDevelopmentCard(org.soc.common.game.
     * developmentCards.DevelopmentCard)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getDevelopmentCardsCount()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getResourcesCount()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#isOnTurn()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getStock()
     */
     ...
     * 
     * @see
     * org.soc.common.game.GamePlayer#setStock(org.soc.common.board.pieces.PlayerPieceList
     * )
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getPorts()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getDevelopmentCards()
     */
     ...
     * 
     * @see
     * org.soc.common.game.GamePlayer#amountGold(org.soc.common.board.resources.ResourceList
     * )
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#amountGold()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#setOnTurn(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getMaximumCardsInHandWhenSeven()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#setMaximumCardsInHandWhenSeven(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getResources()
     */
     ...
     * (non-Javadoc)
     * 
     * @seesoc.common.game.GamePlayer#setResources(org.soc.common.board.resources.
     * ResourceList)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#setColor(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.game.GamePlayer#getColor()
     */
     ...
     * 
     * @see
     * org.soc.common.game.GamePlayer#addRoadTokenChangedEventHandler(org.soc.common
     ...
     * 
     * @see org.soc.common.game.player.GamePlayer#getUser()
     */
    @Override
    public User getUser()
    {
