...
import org.soc.common.annotations.OpenSettlers;
...
public class FivetoTwoJunglePort extends AbstractPort
{
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.ports.AbstractPort#getInAmount()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.ports.AbstractPort#getOutAmount()
     */
    @Override
