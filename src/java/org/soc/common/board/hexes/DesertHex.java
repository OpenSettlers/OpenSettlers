...
public class DesertHex extends AbstractHex
{
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.LandHex#isBuildableLand()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.LandHex#isBuildableSea()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.LandHex#isPartOfGame()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.LandHex#isPiratePlaceable()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.LandHex#isRobberPlaceable()
     */
    @Override
