...
public class SeaHex extends AbstractHex
{
     ...
     * 
     * @see
     * org.soc.common.board.hexes.Hex#setTerritory(org.soc.common.board.territories.
     * Territory)
     */
    @Override
     ...
     * 
     * @see org.soc.common.board.hexes.Hex#getChit()
     */
    @Override
    public Chit getChit()
    {
     ...
     * 
     * @see org.soc.common.board.hexes.Hex#setChit(org.soc.common.board.Chit)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.hexes.AbstractHex#hasPort()
     */
    @Override
