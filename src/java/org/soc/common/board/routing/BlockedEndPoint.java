...
public class BlockedEndPoint implements GraphPoint
{
     ...
     * 
     * @see org.soc.common.board.routing.IGraphPoint#isTownBuildable()
     */
    @Override
     ...
     * Ignored
     * 
     * @see org.soc.common.board.routing.IGraphPoint#setTownBuildable(boolean)
     */
    @Override
     ...
     * Returns always null
     * 
     * @see org.soc.common.board.routing.IGraphElement#getPiece()
     */
    @Override
     ...
     * Returns always null
     * 
     * @see org.soc.common.board.routing.IGraphElement#getPlayer()
     */
    @Override
     ...
     * 
     * @see
     * org.soc.common.board.routing.IGraphElement#setPlayerPiece(org.soc.common.board
     * .pieces.PlayerPiece)
     */
    @Override
