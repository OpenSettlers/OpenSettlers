...
public class HexSideImpl implements Serializable, HexSide
{
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getHex1()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getHex2()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getHexPoint1()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getHexPoint2()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getHighestOrLeftestHex()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getNeighbourPoints()
     */
    @Override
    public List<HexPoint> getNeighbourPoints()
    {
        ...
        switch (getDirection())
        {
            case UPDOWN:
                ...
                result.add(new HexPoint(hex1, hex2, new HexLocation(top.getW()
                                + offset, top.getH() - 1)));
                result.add(new HexPoint(hex1, hex2, new HexLocation(top.getW()
                                + offset, top.getH() + 1)));
                break;
    ...
    private void calculateHexes()
    {
         ...
         * 
         * 
         * var x = from l in locations group l by l into lunique where
         * lunique.Count() == 2 select lunique.Key;
         */
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getDirection()
     */
    @Override
    ...
    private void calculatePoints()
    {
        ...
        {
            case UPDOWN:
                loc1 = new HexLocation(offset + lefttop.getW(),
                                lefttop.getH() - 1);
                loc2 = new HexLocation(offset + lefttop.getW(),
                                lefttop.getH() + 1);
                break;
            case SLOPEDOWN:
                loc1 = new HexLocation(offset + lefttop.getW(),
            ...
            case SLOPEUP:
                ...
                loc2 = new HexLocation(lefttop.getW() - 1 + offset,
                                lefttop.getH() + 1);
                break;
        }
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getOtherPoint(org.soc.common.board.layout.HexPoint)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.soc.common.board.layout.HexSide#getOtherLocation(org.soc.common.board.layout.HexLocation)
     */
    @Override
    ...
    @Override
    public List<HexLocation> getNeighbourLocations()
    {
    ...
    @Override
    public List<HexSideImpl> getNeighbourSides()
    {
        // TODO Auto-generated method stub
        return null;
    }
