...
import org.soc.common.bots.BotPrincipal;
...
public abstract class AbstractGameServer implements GameServer
{
     ...
     * @return the random
     */
    public org.soc.common.server.randomization.Random getRandom()
    {
        return random;
    }
     ...
     * 
     * @see
     * org.soc.common.server.IGameServer#sendAction(org.soc.common.actions.gameAction
     * .GameAction)
     */
    @Override
